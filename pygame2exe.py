...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "pybounce.py"
 
        #Name of program
        self.project_name = "PyBounce"
        ...
        self.license = "Wow! No such a licence for this!"
 
        #Auhor of program
        self.author_name = "XzPeter"
        self.author_email = "xzpeter@gmail.com"
        ...
        self.extra_datas = ['font', 'ChangeLog']

        #peter: more cmds
        namestr = self.project_name + "_" + self.project_version
        rarexe = r'"C:\Program Files\WinRAR\rar"'
        self.last_cmds = [
            'copy *.dll dist',
            'rename dist %s' % namestr,
            '%s a %s.rar %s' % (rarexe, namestr, namestr)
        ]
    ...
    def run(self):
        ...
        print "running last cmds..."
        for cmd in self.last_cmds:
            os.system(cmd)
